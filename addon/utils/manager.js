...
export default Ember.Object.extend({
	...
	addOperation(type, modelType, params, alias) {
		var id = generateId();
		...
		if (params.join) {
			const join = this.__storedOperations.findBy('alias', params.join);
